...
def save_coordinates(description, x, y, z):
   ...
   #  if
        ...
        # Create a dictionary from the function attributes then convert the dictionary to a pandas data fame
        ...
        if                        # this is true if there is at least one True in test_df
...
if __name__ == '__main__':
    ...
    print('i am at line 100 and x =  ', x, '  y =   ', y, '  z =  ',z)
